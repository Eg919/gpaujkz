...
exportToExcel() {
  try {
    ...
    const titleRow = [`Rapport des activités 1er trimestre année ${this.sessionsAnne}`];
    ...
    XLSX.writeFile(wb, `Rapport_activites_1er_trimestre_${this.sessionsAnne}.xlsx`);
  } catch (error) {
