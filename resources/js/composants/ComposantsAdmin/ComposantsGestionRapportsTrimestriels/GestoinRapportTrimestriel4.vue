...
exportToExcel() {
  try {
    ...
    const titleRow = [`Rapport des activités 4éme trimestre année ${this.sessionsAnne}`];
    ...
    XLSX.writeFile(wb, `Rapport_activites_4éme_trimestre_${this.sessionsAnne}.xlsx`);
  } catch (error) {
