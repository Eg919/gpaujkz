<template>
  <div class="gestion-historiques p-2 h-[98vh] overflow-y-auto border border-gray-300 rounded-lg mt-9">
              ...
              <template v-for="(activite, indexActivite) in effet.activites" :key="activite.id">
                ...
                <tr v-if="effet.activites.length">
                  ...
                  <td
                    ...
                    :class="calculatePercentage(activite) < 100 ? 'text-red-500' : 'text-green-600'"
                  >
