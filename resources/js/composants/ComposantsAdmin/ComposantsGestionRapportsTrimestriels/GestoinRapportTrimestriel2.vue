...
exportToExcel() {
  try {
    ...
    const titleRow = [`Rapport des activités 2éme trimestre année ${this.sessionsAnne}`];
    ...
    XLSX.writeFile(wb, `Rapport_activites_2éme_trimestre_${this.sessionsAnne}.xlsx`);
  } catch (error) {
